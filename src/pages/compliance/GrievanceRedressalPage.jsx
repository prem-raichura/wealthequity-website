  ...
  return (
    <div className="relative isolate overflow-hidden">
      <div className="absolute inset-0 -z-10 h-full w-full bg-dark-bg">
        <div className="absolute bottom-0 -left-60 w-[30rem] h-[30rem] bg-brand-green/10 rounded-full blur-3xl opacity-60"></div>
      </div>
        ...
        <AnimatedSection>
            <div className="max-w-4xl mx-auto text-secondary-gray space-y-4 text-lg bg-gray-900/40 p-8 rounded-2xl border border-gray-800">
                ...
                <ul className="list-disc list-inside pl-4">
                    <li>Email: <a href="mailto:ajay.sharma@example.com" className="text-brand-green">ajay.sharma@example.com</a></li>
                    <li>Phone: <a href="tel:+919866243862" className="text-brand-green">+91 9866243862</a></li>
                </ul>
        ...
        <AnimatedSection>
            <div className="overflow-x-auto max-w-5xl mx-auto">
                <table className="w-full text-left border-collapse">
                    <thead>
                        <tr><Th>Designation</Th><Th>Contact Person</Th><Th>Address</Th><Th>Contact No.</Th><Th>Email-ID</Th><Th>Working Hours</Th></tr>
                    </thead>
                    <tbody>
                        <tr><Td>Compliance Officer</Td><Td>Ajay Sharma</Td><Td>Same as registered</Td><Td>9866243862</Td><Td>info@example.com</Td><Td>10AM-4PM</Td></tr>
                        <tr><Td>CEO</Td><Td>Ajay Sharma</Td><Td>Same as registered</Td><Td>9866243862</Td><Td>info@example.com</Td><Td>10AM-4PM</Td></tr>
                    </tbody>
                </table>
            </div>
        </AnimatedSection>
